...
//        比较重要的可以提前 ，权重设置boots默认1.0
        ...
        SearchRequestBuilder requestBuilder = this.esClient.prepareSearch(INDEX_NAME)
                ...
                .setFetchSource(HouseIndexKey.HOUSE_ID, null);//只返回固定的不是返回所有数据
    ...
    public ServiceResult<List<String>> suggest(String prefix) {
        ...
        CompletionSuggestionBuilder suggestion = SuggestBuilders
                .completionSuggestion("suggest")//根据该字段的存值进行补全
                .prefix(prefix)
                .size(5);//提示个数
        ...
        SearchRequestBuilder requestBuilder = this.esClient.prepareSearch(INDEX_NAME)
                ...
                .addAggregation(
                        ...
                        AggregationBuilders.terms(HouseIndexKey.AGG_DISTRICT)
                                .field(HouseIndexKey.DISTRICT)//索引名字
                ).setSize(0);//只需要聚合数据
